  ...
  return (
    <div className="sticky top-0 z-30 mx-auto flex w-full max-w-[1500px] items-center justify-between gap-4 border-b border-white/10 bg-slate-950/80 px-5 py-4 backdrop-blur-xl backdrop-saturate-150">
      <div className="flex items-center gap-4">
        <button onClick={onMenuToggle} className="xl:hidden inline-flex items-center justify-center rounded-3xl border border-white/10 bg-white/5 p-2 text-slate-100 transition hover:bg-white/10">
          <Menu size={18} />
        </button>
